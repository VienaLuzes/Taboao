...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Lay_04_atlas_.png?1489601494475", id:"Lay_04_atlas_"}
	]
};
...
lib.ssMetadata = [
		{name:"Lay_04_atlas_", frames: [[1026,0,956,481],[0,691,1024,685],[0,0,1024,689],[1026,483,962,476],[1026,961,960,474],[1984,0,54,58],[189,1378,100,43],[0,1378,100,163],[102,1378,85,150],[2015,60,27,46],[1984,60,29,49],[1984,111,18,31],[2015,108,18,32]]}
];
...
(lib.Lay_04 = function(mode,startPosition,loop) {
	...
	this.instance_49 = new lib.Camada2();
	this.instance_49.parent = this;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_49},{t:this.instance_48},{t:this.instance_47},{t:this.instance_46},{t:this.instance_45},{t:this.instance_44},{t:this.instance_43},{t:this.instance_42},{t:this.instance_41},{t:this.instance_40},{t:this.instance_39},{t:this.instance_38}]}).wait(1));
